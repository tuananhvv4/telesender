    ...
    <div class="grid grid-2">
        <section class="card">
            <div class="builder-block-head">
                <div>
                    <h2 class="section-title"><?= $editEmoji ? 'Cập nhật emoji riêng' : 'Thêm emoji riêng mới' ?></h2>
                    <p class="section-copy">Bạn có thể thêm thủ công từng emoji hoặc dùng nút import nhanh để nhập nhiều dòng một lần.</p>
                </div>
            </div>
            ...
            <form class="form-grid" method="post" action="<?= e(url($editEmoji ? '/custom-emojis/update' : '/custom-emojis')) ?>">
                ...
                <div class="actions">
                    ...
                    <button class="button secondary" type="button" data-emoji-import-open>Import nhanh</button>
                    <?php if ($editEmoji): ?>
...
<div class="app-modal emoji-import-modal" id="emoji_import_modal" hidden aria-hidden="true">
    ...
    <div class="app-modal-dialog" role="dialog" aria-modal="true" aria-labelledby="emoji_import_title">
        ...
        <form method="post" action="<?= e(url('/custom-emojis/import-bulk')) ?>">
            <?= csrf_field() ?>
            ...
            <div class="app-modal-actions">
                ...
                <button class="button primary" type="submit">Import vào hệ thống</button>
            </div>
        </form>
    </div>
</div>
