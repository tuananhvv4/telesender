...
return [
    ...
    'schedules' => [
        ...
        [
            ...
            'schedule_config' => ['interval_hours' => 2, 'minute' => 0],
            'timezone' => 'Asia/Ho_Chi_Minh',
        ...
        [
            ...
            'cron_expression' => '0 */3 * * *',
            'schedule_type' => 'interval_hours',
            'schedule_config' => ['interval_hours' => 3, 'minute' => 0],
            'timezone' => 'Asia/Ho_Chi_Minh',
        ...
        [
            ...
            'cron_expression' => '0 */4 * * *',
            'schedule_type' => 'interval_hours',
            'schedule_config' => ['interval_hours' => 4, 'minute' => 0],
            'timezone' => 'Asia/Ho_Chi_Minh',
        ...
        [
            ...
            'cron_expression' => '0 */6 * * *',
            'schedule_type' => 'interval_hours',
            'schedule_config' => ['interval_hours' => 6, 'minute' => 0],
            'timezone' => 'Asia/Ho_Chi_Minh',
        ...
        [
            ...
            'schedule_type' => 'daily_times',
            'schedule_config' => ['times' => ['08:00', '12:00', '20:00']],
            'timezone' => 'Asia/Ho_Chi_Minh',
        ...
        [
            ...
            'schedule_type' => 'daily_times',
            'schedule_config' => ['times' => ['08:00', '11:00', '14:00', '20:00']],
            'timezone' => 'Asia/Ho_Chi_Minh',
        ...
        [
            ...
            'schedule_type' => 'weekly_times',
            'schedule_config' => ['days' => ['1', '2', '3', '4', '5'], 'times' => ['09:00']],
            'timezone' => 'Asia/Ho_Chi_Minh',
        ...
        [
            ...
            'schedule_type' => 'weekly_times',
            'schedule_config' => ['days' => ['1', '2', '3', '4', '5'], 'times' => ['09:00', '13:00', '17:00']],
            'timezone' => 'Asia/Ho_Chi_Minh',
        ...
        [
            ...
            'cron_expression' => '30 8 * * 1,2,3,4,5 | 30 11 * * 1,2,3,4,5 | 30 14 * * 1,2,3,4,5 | 30 17 * * 1,2,3,4,5',
            'schedule_type' => 'weekly_times',
            'schedule_config' => ['days' => ['1', '2', '3', '4', '5'], 'times' => ['08:30', '11:30', '14:30', '17:30']],
            'timezone' => 'Asia/Ho_Chi_Minh',
        ...
        [
            ...
            'schedule_type' => 'weekly_times',
            'schedule_config' => ['days' => ['0', '6'], 'times' => ['10:00']],
            'timezone' => 'Asia/Ho_Chi_Minh',
